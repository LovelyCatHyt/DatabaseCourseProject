...
namespace StudentManageSystem.Migrations
{
    ...
    [Migration("20220606033721_UniqueCourseSelection")]
    partial class UniqueCourseSelection
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentManageSystem.Entities.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("StudentManageSystem.Entities.CourseSelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("StudentManageSystem.Entities.CourseSelection", b =>
                {
                    b.HasOne("StudentManageSystem.Entities.Course", "Course")
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StudentManageSystem.Entities.Student", "Student")
                        .WithMany()
