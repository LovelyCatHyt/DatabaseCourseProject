...
namespace StudentManageSystem.DataBase
{
    public class StudentDbValidator
    {
        ...
        /// <returns></returns>
        public bool Validate(Student student, out string msg)
        {
        ...
        /// <returns></returns>
        public bool Validate(IEnumerable<Student> students, out string msg, bool stopOnFirstInvalid = false)
        {
